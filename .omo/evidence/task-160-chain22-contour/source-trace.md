# Task 160 source trace: benchmark-05 chain22 contour
...
The benchmark-05 chain22 final contour placement is therefore
...
uses visible oracle output and current mismatch diagnostics to close the chain22
contour residual without weakening benchmark-04 SP+ parity or existing mismatch
diagnostics.

## Current RED target

- Existing pair coverage already asserts benchmark-05 chain22 SP+ pair:
  `(4.84,25,2)`.
- New focused assertion requires benchmark-05 chain22 contour to match
