...
def standard_ppa_settings() -> PpaSettings:
    return PpaSettings(
        ...
        phases=(
            PpaPhase(timestep=0.008, temperature=0.001, step_count=124999, skin=1.0),
        ),
    )
...
def accelerated_ppa_settings() -> PpaSettings:
    return PpaSettings(
        ...
        phases=(
            PpaPhase(timestep=0.008, temperature=0.1, step_count=1249, skin=0.7),
            PpaPhase(timestep=0.008, temperature=0.05, step_count=1249, skin=0.7),
