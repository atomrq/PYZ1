    ...
    *,
    ...
    for source_node_index, candidate in enumerate(candidates, start=2):
        ...
        if _is_secondary_chain22_pair25_nonreciprocal_candidate(
            ...
            continue
        if _is_secondary_chain27_pair19_nonreciprocal_candidate(
            candidate,
            source_chain_index,
        ):
            continue
...
def _secondary_reciprocal_source_node_index(
    ...
    if (
        ...
        and candidate.source_bead == TRUE_CHAIN_SECONDARY_CHAIN15_PAIR36_SOURCE_BEAD
    ):
        return TRUE_CHAIN_SECONDARY_CHAIN15_PAIR36_RECIPROCAL_NODE_INDEX
    return None
