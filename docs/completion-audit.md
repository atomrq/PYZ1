...
3. If scientific parity is the priority, continue reducer geometry debugging
  ...
  contour placement, task-157 closes chain25 contour placement, and task-158
  closes chain9 contour placement, so the next reducer gap starts at chain43
  final geometry/contour, Lpp, and summary alignment.
   Use
