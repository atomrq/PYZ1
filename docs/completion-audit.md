...
3. If scientific parity is the priority, continue reducer geometry debugging
  ...
  contour placement, and task-157 closes chain25 contour placement, so the
  next reducer gap starts at chain9 final geometry/contour, Lpp, and summary
  alignment.
   Use
