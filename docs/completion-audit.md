...
3. If scientific parity is the priority, continue reducer geometry debugging
   ...
   closes chain9 contour placement, and task-159 closes chain43 contour
   placement, so the next reducer gap starts at chain22 final
