...
3. If scientific parity is the priority, continue reducer geometry debugging
   ...
   chain48 contour placement; task-154 closes chain34 contour placement, so
   the next reducer gap starts at chain36 final
