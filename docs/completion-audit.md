...
3. If scientific parity is the priority, continue reducer geometry debugging
   ...
   task-147 aligns benchmark-05 chain40, and task-148 aligns benchmark-05
   chain46; the next reducer gap starts at chain48/49 source/position placement,
   remaining
