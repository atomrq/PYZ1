...
3. If scientific parity is the priority, continue reducer geometry debugging
   ...
   chain46, task-149 aligns benchmark-05 chain48, and task-150 aligns
   benchmark-05 chain49; the next reducer gap starts at final geometry, Lpp,
   and summary alignment. Use
