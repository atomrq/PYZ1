...
3. If scientific parity is the priority, continue reducer geometry debugging
   ...
   task-147 aligns benchmark-05 chain40; the next reducer gap starts at
   chain46/48/49 source/position placement,
   remaining
