...
- `.omo/evidence/task-136-chain20-spplus-residual/pytest.txt`:
  remote GPU-cluster split: `44 passed`, `36 passed`, `39 passed`, and SP+
  shards `10/10/10/10/10/9 passed`
- `.omo/evidence/task-136-chain20-spplus-residual/ruff.txt`:
  `All checks passed!`
- `.omo/evidence/task-136-chain20-spplus-residual/basedpyright.txt`:
  `0 errors, 0 warnings, 0 notes`
- `.omo/evidence/task-136-chain20-spplus-residual/package-smoke.txt`:
  `1 passed`
- `.omo/evidence/task-136-chain20-spplus-residual/diff-check.txt`:
  `git diff --check passed`
- `.omo/evidence/task-136-chain20-spplus-residual/full-gate-sacct.txt`:
  final remote Slurm gate jobs `416211`-`416214`, `416216`-`416221`,
  `416224`, and `416227`-`416229` completed with `0:0` exit codes after the
  valid RED assertion (`416207`) and focused GREEN v2 (`416210`)
