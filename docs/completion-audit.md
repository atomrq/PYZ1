...
- `.omo/evidence/task-65-benchmark03-source-geometry/pytest.txt`:
  `119 passed`
...
- `.omo/evidence/task-65-benchmark03-source-geometry/default-spplus-01-05-source-deltas.txt`:
  ...
  source-bead residual is `1.4679581658620817` at chain 1 node 5, so benchmark-03
...
3. If scientific parity is the priority, continue reducer geometry debugging
   ...
   node/pair sequence mismatch and task-65 exposed the max source-bead residual
   at chain 1 node 5. For benchmark-01/02, the next reducer gap is
