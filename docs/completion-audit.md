...
3. If scientific parity is the priority, continue reducer geometry debugging
  ...
  task-155 closes chain36 contour placement, and task-156 closes chain27
  contour placement, so the next reducer gap starts at chain25 final
   geometry/contour, Lpp, and summary alignment.
   Use
