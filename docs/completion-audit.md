...
3. If scientific parity is the priority, continue reducer geometry debugging
   ...
   benchmark-05 chain39, and task-145 aligns benchmark-05 chain42; the next
   reducer gap starts at chain40/43/46/48/49 source/position placement,
   remaining
