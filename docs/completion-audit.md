...
- `.omo/evidence/task-135-chain20-chain29-spplus-residual/pytest.txt`:
  remote GPU-cluster split: `44 passed`, `36 passed`, `39 passed`, and SP+
  shards `10/9/10/10/10/9 passed`
- `.omo/evidence/task-135-chain20-chain29-spplus-residual/ruff.txt`:
  `All checks passed!`
- `.omo/evidence/task-135-chain20-chain29-spplus-residual/basedpyright.txt`:
  `0 errors, 0 warnings, 0 notes`
- `.omo/evidence/task-135-chain20-chain29-spplus-residual/package-smoke.txt`:
  `1 passed`
- `.omo/evidence/task-135-chain20-chain29-spplus-residual/diff-check.txt`:
  `git diff --check passed`
- `.omo/evidence/task-135-chain20-chain29-spplus-residual/full-gate-sacct.txt`:
  final remote Slurm gate jobs `416178`, `416188`, `416191`, `416193`-`416195`,
  `416197`-`416202`, and `416204`-`416205` completed with `0:0` exit codes
  after the valid RED assertion (`416168`) and focused GREEN v5 (`416177`)
