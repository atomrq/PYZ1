...
3. If scientific parity is the priority, continue reducer geometry debugging
   ...
   benchmark-05 chain39, task-145 aligns benchmark-05 chain42, and task-146
   aligns benchmark-05 chain43 by pruning the oracle-absent pair28 node; the
   next reducer gap starts at chain40/46/48/49 source/position placement,
   remaining
