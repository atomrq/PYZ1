...
3. If scientific parity is the priority, continue reducer geometry debugging
   ...
   chain39, and task-152 closes chain39 contour placement; the next reducer
   gap starts at chain48 final geometry/contour, Lpp, and summary alignment.
   Use
