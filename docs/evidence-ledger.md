...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  task-142 aligns the chain39 pair sequence, and task-145 aligns the chain42
  one-way pair34 sequence;
  these cumulatively
