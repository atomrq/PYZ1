...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  aligns the chain30 pair sequence, and task-138 aligns the chain31 pair
  sequence;
  these cumulatively
