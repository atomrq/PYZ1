...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  one-way pair34 sequence, and task-146 prunes chain43's oracle-absent pair28
  node;
  these cumulatively
