...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  chain39 contour residual, and task-153 closes the chain48 contour residual
  while moving the largest remaining contour gap to chain34;
  these cumulatively
