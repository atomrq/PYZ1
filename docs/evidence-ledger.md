...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  sequence, and task-126 aligns the chain12/chain19 reciprocal pair sequence;
  these cumulatively
