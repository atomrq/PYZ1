...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  chain46 pair sequence, and task-149 aligns the chain48 pair sequence;
  these cumulatively
