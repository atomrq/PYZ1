...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  reciprocal, task-136 prunes chain20's extra pair49 contacts, and task-137
  aligns the chain30 pair sequence;
  these cumulatively
