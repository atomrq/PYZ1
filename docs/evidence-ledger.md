...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  source, task-119 aligns the chain4 pair sequence, and task-120 aligns the
  chain5/chain16 reciprocal pair sequence; these cumulatively
