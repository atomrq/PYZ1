...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  sequence, task-139 aligns the chain32 pair sequence, and task-140 aligns the
  chain34 pair sequence;
  these cumulatively
