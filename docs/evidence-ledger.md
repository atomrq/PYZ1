...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  chain6/chain37/chain2 pair sequence, and task-122 aligns the chain9/chain27
  pair sequence; these cumulatively
