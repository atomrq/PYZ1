...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  sequence, task-126 aligns the chain12/chain19 reciprocal pair sequence, and
  task-127 aligns the chain13 pair sequence; these cumulatively
