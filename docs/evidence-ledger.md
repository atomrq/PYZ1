...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  node, task-147 aligns the chain40 pair sequence, and task-148 aligns the
  chain46 pair sequence;
  these cumulatively
