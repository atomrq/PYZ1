...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  residual, and task-159 closes the chain43 contour residual while moving the
  largest remaining contour gap to chain22;
  these cumulatively
