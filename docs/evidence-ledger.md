...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  task-127 aligns the chain13 pair sequence, and task-128 aligns the
  chain15/chain36 reciprocal pair sequence; these cumulatively
