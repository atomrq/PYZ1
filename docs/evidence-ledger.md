...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  chain17 reciprocal, and task-130 aligns the chain18/chain48 reciprocal pair
  sequence while preserving chain4 into chain18; these cumulatively
