...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  chain5/chain16 reciprocal pair sequence, and task-121 aligns the
  chain6/chain37/chain2 pair sequence; these cumulatively
