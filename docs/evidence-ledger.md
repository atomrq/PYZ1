...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  task-116 aligns chain3 to the pair25 contact and task-117 aligns the
  reciprocal chain25 pair3 source/node; these cumulatively improve benchmark-05
  node-count, pair-count, `Lpp`, prior `Z`, and local source residuals while
  leaving the current `Z` regression, chain25 pair40/source placement,
  geometry, remaining reciprocal coverage, node-count, pair-detail, and
