...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  chain34 pair sequence, and task-141 aligns the chain37 pair sequence;
  these cumulatively
