...
- default geometrical Z1+ numerical parity across all benchmarks
  ...
  reciprocal, and task-136 prunes chain20's extra pair49 contacts;
  these cumulatively
